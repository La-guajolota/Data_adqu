...
def print_scan(img): #Imprime la matriz escaneada

    # Modificar "img" con las dimensiones necesarias para  la practica 
    """"
    img = [
        [0, 0, 1],
        [0, 1, 0],
    ...
    white = "\u001b[30m" #codigo ANSI para el color negro
    black = "\u001b[37m" #codigo ANSI para el color blanco
